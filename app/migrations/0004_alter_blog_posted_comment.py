# Generated by Django 4.2.16 on 2024-12-13 11:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='blog',
            name='posted',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2024, 12, 13, 14, 39, 13, 420955), verbose_name='Опубликована'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=datetime.datetime(2024, 12, 13, 14, 39, 13, 421953), verbose_name='Дата комментария')),
