...
class AnketaForm(forms.Form):
    ...
    job = forms.CharField(label='Место работы', min_length=2, max_length=100)
    gender = forms.ChoiceField(label='Ваш пол',
                              choices=[('1', 'Мужской'), ('2', 'Женский')],
                              widget=forms.RadioSelect, initial=1)
    internet = forms.ChoiceField(label='Как часто смотрите новости о новинках бытовой техники',
